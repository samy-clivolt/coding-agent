  ...
  const result = await generateText({
    ...
    tools: {
      read_file: tool({
        ...
        execute: async ({ path }: { path: string }) => {
          try {
            ...
            console.error(`Error reading file at ${path}:`, (error as Error).message);
      ...
      list_files: tool({
        ...
        execute: async ({ path }: { path: string | null }) => {
      ...
      create_pr: tool({
        ...
        execute: async ({ title, body, branch }: { title: string; body: string; branch: string | null }) => {
